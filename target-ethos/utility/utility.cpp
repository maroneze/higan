...
void Utility::synchronizeDSP() {
  ...
  double frequency = inputRatio / outputRatio * config->audio.frequency * config->audio.multiplier;
...
void Utility::synchronizeRuby() {
  ...
  dspaudio.setResamplerFrequency((unsigned)(config->audio.frequency * config->audio.multiplier));
